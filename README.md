...
#### Note:
  ...
  - The new project repository can be found here: [https://sr.ht/~tpapastylianou/trac-compatible-gantt-chart-template](https://sr.ht/~tpapastylianou/trac-compatible-gantt-chart-template)
